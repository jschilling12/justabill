...
class SectionVoteStatsItem(BaseModel):
    section_id: UUID
    counts: VoteCounts
    percents: VotePercents


class BillSectionVoteStatsResponse(BaseModel):
    bill_id: UUID
    items: List[SectionVoteStatsItem]


class BillVoteStatsItem(BaseModel):
    bill_id: UUID
    counts: VoteCounts
    percents: VotePercents


class BillsVoteStatsResponse(BaseModel):
...
class MyBillVoteItem(BaseModel):
    bill_id: UUID
    congress: int
    bill_type: str
    bill_number: int
...
class MyBillsVotesResponse(BaseModel):
    items: List[MyBillVoteItem]

...
def upgrade() -> None:
    # Create enums
    op.execute("CREATE TYPE votetype AS ENUM ('up', 'down', 'skip')")
    op.execute("CREATE TYPE billstatus AS ENUM ('introduced', 'in_committee', 'passed_house', 'passed_senate', 'in_conference', 'passed_both', 'vetoed', 'enacted')")
    ...
    op.create_table('bills',
        ...
        sa.Column('status', sa.Enum('introduced', 'in_committee', 'passed_house', 'passed_senate', 'in_conference', 'passed_both', 'vetoed', 'enacted', name='billstatus'), nullable=True),
    ...
    op.create_table('votes',
        ...
        sa.Column('vote', sa.Enum('up', 'down', 'skip', name='votetype'), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
        sa.ForeignKeyConstraint(['bill_id'], ['bills.id'], ),

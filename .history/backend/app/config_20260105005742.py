...
class Settings(BaseSettings):
    ...
    # Admin / automation key for ingestion & maintenance endpoints
    # Send as header: X-Admin-Key: <value>
    # Optional: if unset/empty, admin endpoints are not additionally protected.

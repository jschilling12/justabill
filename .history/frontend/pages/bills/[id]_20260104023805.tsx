...
import { getBill, submitVote, submitBulkVotes, getUserSummary, BillWithSections, UserBillSummary } from '../../lib/api';
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {activeTab === 'grouped' && (
          <div className="space-y-6">
            {(() => {
              const groups: Array<{ key: string; division?: string | null; title?: string | null; title_heading?: string | null; sectionIds: string[]; sections: typeof bill.sections }> = [];
              ...
              const formatGroupTitle = (g: { division?: string | null; title?: string | null; title_heading?: string | null }) => {
                const parts: string[] = [];
                if (g.division) parts.push(`Division ${g.division}`);
